...
<body>
<body style="background-size: cover; background-image: url(regi_bg.jpeg);">
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
                    ...
                    <p style="color:#dfdfdf">Password</p><input type="password" class="form-control" name="password"  placeholder="6 Character minimum" pattern=".{6,}" id="pass" onfocusout="f1()"/>
